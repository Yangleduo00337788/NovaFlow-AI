...
| 模块 | 表数量 | 表名 |
|------|--------|------|
| 用户权限 | 6 | user, role, permission, role_permission, tenant_member, user_recent_access |
...
| 费用计费 | 4 | billing_quota, billing_record, billing_alert, alert_rule |
