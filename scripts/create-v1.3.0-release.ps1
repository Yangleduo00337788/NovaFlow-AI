...
# 创建 Gitee / GitHub v1.3.0 Release（需环境变量 GITEE_TOKEN、GH_TOKEN）
# 用法:
#   $env:GITEE_TOKEN = '...'
#   $env:GH_TOKEN = '...'   # 或已 gh auth login
#   pwsh scripts/create-v1.3.0-release.ps1

$ErrorActionPreference = 'Stop'
$repoRoot = Split-Path -Parent $PSScriptRoot
$notesFile = Join-Path $repoRoot 'docs\releases\v1.3.0.md'
$giteeNotesFile = Join-Path $repoRoot 'docs\releases\v1.3.0-gitee.txt'
$tag = 'v1.3.0'
$name = 'NovaFlow AI v1.3.0'
