...
/** 三角色演示账号（与 README / DataInitializer 一致） */
export const ROLE_ACCOUNTS = [
  { label: '企业管理员', email: ADMIN_EMAIL, password: ADMIN_PASSWORD, home: /\/dashboard/ },
  { label: '普通用户', email: PORTAL_EMAIL, password: PORTAL_PASSWORD, home: /\/portal/ },
  { label: '平台管理员', email: PLATFORM_EMAIL, password: PLATFORM_PASSWORD, home: /\/platform/ },
] as const
